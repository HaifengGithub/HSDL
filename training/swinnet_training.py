...
def training(traintxtdir, savedir):
    ...
    train_data = ToolnetDataset(traintxtdir, transform=transform_train)
...
if __name__=='__main__':
    ...
    traintxt = os.path.join(traintesttxt_dir,'trainswinnet.txt')
    savedir = os.path.join('pre-trained_model/swinnet.pth')
